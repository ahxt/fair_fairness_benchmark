...
if __name__ == '__main__':
    ...
    for step, (X, attr) in enumerate( train_infinite_loader ):
            ...
            # if epoch % args.log_freq == 0:
                ...
                val_metrics   = test(model=net, test_loader=val_loader, criterion=criterion, target_index = target_index, sensitive_index = sensitive_index, device=device, prefix="val")
                test_metrics  =  test(model=net, test_loader=test_loader, criterion=criterion, target_index = target_index, sensitive_index = sensitive_index, device=device, prefix="test")
